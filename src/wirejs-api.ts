...
export class Api {
  ...
  public async getTransactionAbis(
    ...
    const accounts: string[] = actions.map(
      (action: ser.Action): string => action.account,
    );
  ...
  public serializeTransactionExtensions(
    transaction: Transaction,
  ): [number, string][] {
  ...
  public deleteTransactionExtensionObjects(
    transaction: Transaction,
  ): Transaction {
  ...
  public async deserializeActions(
    actions: ser.Action[],
  ): Promise<ser.Action[]> {
    return await Promise.all(
  ...
  public async deserializeTransactionWithActions(
    ...
    const deserializedActions = await this.deserializeActions(
  ...
  public async transact(
    ...
    transaction = {
      ...transaction,
      transaction_extensions:
        await this.serializeTransactionExtensions(transaction),
  ...
  private async tryGetBlockInfo(
    blockNumber: number,
  ): Promise<GetBlockInfoResult | GetBlockResult> {
    try {
...
export class TransactionBuilder {
  ...
  public associateContextFree(
    contextFreeGroup: ContextFreeGroupCallback,
  ): TransactionBuilder {
  ...
  ): Promise<PushTransactionArgs | ReadOnlyTransactResult | TransactResult> {
    ...
    await Promise.all(
      this.contextFreeGroups.map(
        async (contextFreeCallback: ContextFreeGroupCallback) => {
          const { action, contextFreeAction, contextFreeData } =
            contextFreeCallback({
...
export class ActionBuilder {
  ...
  public as(
    actorName: string | ser.Authorization[] = [],
  ): ActionSerializerType {
