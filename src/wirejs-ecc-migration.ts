import { PrivateKey, PublicKey, Signature } from "./wirejs-jssig";
import { generateKeyPair } from "./wirejs-key-conversions";
...
export const ecc = {
  ...
  randomKey: (
    ...
    if (cpuEntropyBits !== undefined) {
      console.warn(
        "Argument `cpuEntropyBits` is deprecated, " +
  ...
  verify: (
    ...
    const publicKey =
      typeof pubKey === "string" ? PublicKey.fromString(pubKey) : pubKey;
